    ...
    describe.each(['write_file', 'replace'])(
      ...
      (toolName) => {
        it(`should allow ${toolName} to plans directory`, async () => {
          ...
          const validPaths = [
            '/home/user/.gemini/sessions/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/session-1/plans/my-plan.md',
            '/home/user/.gemini/sessions/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/session-1/plans/feature_auth.md',
            '/home/user/.gemini/sessions/new-temp_dir_123/session-1/plans/plan.md', // new style of temp directory
        ...
        it(`should deny ${toolName} outside plans directory`, async () => {
          ...
          const invalidPaths = [
            ...
            '/home/user/.gemini/sessions/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/script.js', // Wrong extension
            '/home/user/.gemini/sessions/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/../../../etc/passwd.md', // Path traversal (Unix)
